...
/* POST users listing. */
router.post('/userSignup',upload.fields([{ name: 'profile_image', maxCount: 1}]),verifyToken,userRegistration);
...
router.post('/editProfileUser',upload.fields([{ name: 'profile_image', maxCount: 1}]),verifyToken,editProfileUser);
